...
TEST(Arhipycheva_Anastasia_ComplexNumberTest, Can_Addition_With_Opposing_Number) {
  int re = 140;
  int im = 444;
...
TEST(Arhipycheva_Anastasia_ComplexNumberTest, Can_Comparison_When_Only_Imaginary) {
  int re = 0;
  int im1 = 444;
  int im2 = 666;
...
TEST(Arhipycheva_Anastasia_ComplexNumberTest, Can_Comparison_When_Only_Real) {
  int re1 = 123;
  int re2 = 12;
  int im = 0;
...
TEST(Arhipycheva_Anastasia_ComplexNumberTest, Can_Comparison_When_Different_Types) {
  int re1 = 123;
  double re2 = 12.556;
  double im1 = 13.487;
  int im2 = 489;
