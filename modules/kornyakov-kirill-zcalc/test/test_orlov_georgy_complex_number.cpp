...
TEST(Orlov_Georgy_ComplexNumberTest, squared_imaginary_number_is_equal_minus_one) {
	// Arrange
...
TEST(Orlov_Georgy_ComplexNumberTest, the_order_of_addition_does_not_affect_the_result) {
	// Arrange
...
TEST(Orlov_Georgy_ComplexNumberTest, the_order_of_multiplication_does_not_affect_the_result) {
	// Arrange
	const ComplexNumber z1(10, 15);
	const ComplexNumber z2(6, 12);
...
TEST(Orlov_Georgy_ComplexNumberTest, large_expression_with_all_ops_gives_the_correct_result) {
	// Arrange
