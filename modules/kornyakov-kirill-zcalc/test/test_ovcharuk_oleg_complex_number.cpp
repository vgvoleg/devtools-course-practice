...
TEST(Ovcharuk_Oleg_ComplexNumberTest, Can_Property_of_Addition_Conjugate) {
    // Arrange
...
TEST(Ovcharuk_Oleg_ComplexNumberTest, Can_Property_of_Commutativity) {
    // Arrange
...
TEST(Ovcharuk_Oleg_ComplexNumberTest, Can_Property_of_Distributivity) {
    // Arrange
